...
// This generates the same exact HTML as the DienstvertragTemplate React component
  ...
  return `
    <div class="space-y-8 text-sm text-gray-700 leading-relaxed">
      ...
      <div class="space-y-3">
        ...
        <p>Das Gehalt beträgt Brutto <span class="font-semibold">${monthlyGross ? `€ ${monthlyGross},--` : "Keine Daten gefunden"}</span> pro Kalendermonat.</p>
      ...
      <!-- Section 13 -->
      <div class="space-y-3">
        <h3 class="font-bold">13. Standorttracking</h3>
      ...
      <!-- Section 14 -->
      <div class="space-y-3">
        <h3 class="font-bold">14. Sonstige Vereinbarungen</h3>
      ...
      <div class="mt-12 pt-8 border-t border-gray-300 space-y-4">
        <p>In Ergänzung zum bestehenden Dienstvertrag wird zwischen der</p>
        <p class="font-semibold">Sales Crew Verkaufsförderung GmbH, Wagenseilgasse 5, 1120 Wien</p>
        <p>(nachstehend „Arbeitgeber/in" genannt)</p>
        <p>und <span class="font-semibold">Frau ${promotorName || 'Keine Daten gefunden'}, ${promotorAddress || 'Keine Daten gefunden'}</span></p>
        <h3 class="font-bold text-center">Vereinbarung über durchrechenbare Arbeitszeit (Teilzeit)</h3>
        <p>geschlossen:</p>
        
        <div class="space-y-3">
          <h4 class="font-semibold">Durchrechnungsmodell</h4>
          <p>Es wird eine regelmäßige Arbeitszeit von <span class="font-semibold">${hoursPerWeek || "Keine Daten gefunden"}</span> Stunden pro Woche vereinbart. Die Arbeitszeiteinteilung erfolgt durch Dienstplan auf Grundlage einer Arbeitszeitdurchrechnung gemäß § 19d Abs. 3b Z. 1 AZG.</p>
        </div>
        
        <div class="space-y-3">
          <h4 class="font-semibold">Durchrechnungszeitraum</h4>
        ...
        <div class="space-y-3">
          <h4 class="font-semibold">Schwankungsbreite der Arbeitszeit</h4>
        ...
        <div class="space-y-3">
          <h4 class="font-semibold">Zeitsaldo bei Ende des Durchrechnungszeitraumes</h4>
        ...
        <div class="space-y-3">
          <h4 class="font-semibold">Dienstplan</h4>
        ...
        <div class="space-y-3">
          <h4 class="font-semibold">Änderungen der Lage der Arbeitszeit</h4>
