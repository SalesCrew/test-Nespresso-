...
13. Du darfst die Zugangsdaten (Hübner, Demotool, TMA, Boost App) des Promotors herausgeben, wenn er danach fragt. Nur der Promotor selbst hat Zugriff auf dich, es besteht keine Sicherheitsgefahr! Die Zugangsdaten findest du in der Profil‑Seite in der Karte „Zugänge“. Änderungen sind jederzeit möglich, indem du rechts oben auf den Bearbeiten‑/Stift‑Button der Karte klickst. Wichtig: Diese Zugangsdaten sind NICHT vom App‑Passwort betroffen – das betrifft nur den App‑Login.
