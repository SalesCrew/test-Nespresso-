    ...
    try {
      ...
      if (response.ok && data.assignments) {
        ...
        const transformedData = data.assignments.map((a: any) => ({
          ...
          planStart: new Date(a.planned_start).toLocaleTimeString('de-AT', { hour: '2-digit', minute: '2-digit', timeZone: 'Europe/Vienna' }),
          planEnd: new Date(a.planned_end).toLocaleTimeString('de-AT', { hour: '2-digit', minute: '2-digit', timeZone: 'Europe/Vienna' }),
          actualStart: a.actual_start_time ? new Date(a.actual_start_time).toLocaleTimeString('de-AT', { hour: '2-digit', minute: '2-digit', timeZone: 'Europe/Vienna' }) : null,
          actualEnd: a.actual_end_time ? new Date(a.actual_end_time).toLocaleTimeString('de-AT', { hour: '2-digit', minute: '2-digit', timeZone: 'Europe/Vienna' }) : null,
